...
app = Flask(__name__)
app.json.ensure_ascii = False  # 让JSON返回正常中文，不转成\u编码
...
SEED_SENTENCES = {
    ...
    ("夏天", "外面", "雨", "下午", "无风", "潮湿"): "梅雨季的雨黏在皮肤上，空气重得像裹了一层湿布。",
    ("夏天", "在家", "雨", "夜晚", "无风", "潮湿"): "窗玻璃蒙着一层雾气，屋里潮潮的，衣服晾着都干不透。",
    ("夏天", "外面", "晴", "傍晚", "微风", "潮湿"): "傍晚风终于起了，可湿气还黏在身上，衬衫贴着后背。",
    ("夏天", "外面", "多云", "上午", "微风", "潮湿"): "云压得低低的，空气闷闷的，走两步就出汗。",
    ("冬天", "外面", "晴", "上午", "大风", "干燥"): "干冷的风刮过来，脸颊被吹得发紧，呼出的气都是白的。",
    ("冬天", "在家", "晴", "下午", "无风", "干燥"): "阳光斜斜地照进屋里，暖暖的，但空气还是干得嘴唇发紧。",
    ("冬天", "外面", "阴", "傍晚", "大风", "干燥"): "风一阵阵灌进领口，手指冻得有点僵，得揣兜里。",
    ("春天", "外面", "晴", "下午", "微风", "干爽"): "阳光晒在身上刚刚好，风一吹带着点花粉的味道。",
    ("春天", "外面", "雨", "上午", "无风", "潮湿"): "细雨飘在脸上凉凉的，空气里有种湿润的青草味。",
    ("秋天", "在家", "晴", "早晨", "无风", "干爽"): "早上的光很干净，屋里凉丝丝的，很适合裹着毯子发呆。",
    ("秋天", "外面", "多云", "夜晚", "微风", "干爽"): "夜里风凉凉的吹过来，很清醒，路灯下的风带着秋天的安静。",
    ("夏天", "外面", "雷", "下午", "大风", "潮湿"): "闷雷滚过头顶，风突然变大，空气里全是要下雨的味道。",
    ("冬天", "外面", "雪", "上午", "微风", "干燥"): "雪花落在睫毛上凉凉的，鞋底踩在雪地上咯吱作响。",
}
